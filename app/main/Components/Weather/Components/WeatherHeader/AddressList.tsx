...
const AddressList = () => {
    ...
    return (
        <div onClick={toggleList}
             className={`flex ${locationsData.length>1 ? "cursor-pointer" : "cursor-default"} items-center max-md:justify-center justify-start gap-2.5 relative max-md:w-full w-fit md:max-w-[40%]`}>
                <h1 className={"max-md:text-center text-3xl w-fit  font-light"}>{locationsData[locationPointer]?.address ?? "..."}</h1>
